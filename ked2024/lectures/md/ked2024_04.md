...
## Your Computer - What is it actually?
...
# Storing Files {.white-text data-background="../images/drawer_unsplash.jpg"}

## There is an analogue equivalent

Old-fashioned and you have likely never used one (and won't).

![](../images/file_cabinet_hierarchy.png)
...
- wie Aktenschrank mit Ordner - Navigation in diesem Baum/Aktenschrank (tiefer/höher)
...
You are in `/home/myuser/documents` containing the subfolder `my_docs`and `your_docs`.

- What is the absolute path to `your_docs`?

- What is the relative path to `your_docs`?

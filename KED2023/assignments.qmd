...
You have to submit two assignments to complete the seminar successfully. The purpose of the assignments is not making the course hard to pass but rather to foster your engagement with the covered topics. As you like, you may prefer to work in teams to discuss different approaches. Nonetheless, each student has to come up with their own solution and submit it before the deadline. 

| #    | Topic                                                        | Published     | Deadline (by midnight)      | Solution                                                     |
| -- | --------------------------------- | ------------------------- | ----------------------------------------------- | --------------------------------------------- |
| 1    | [Data Wrangling](https://aflueckiger.github.io/KED2023/assignments/assignment_1/KED2023_assignment_1.pdf) | 16 March 2023 | 23 March 2023 | [Example Solution](https://github.com/aflueckiger/KED2023/blob/main/docs/assignments/assignment_1/flueckiger_KED2023_1_solutions.sh) |
| 2    | [Regex NLP](https://aflueckiger.github.io/KED2023/assignments/assignment_2/KED2023_assignment_2.pdf) | 30 March 2023 | 06 April 2023- | [Example Solution](https://github.com/aflueckiger/KED2023/blob/main/docs/assignments/assignment_2/flueckiger_KED2023_2_solutions.sh) |
...
- [Gender differences in 1 August speeches](materials/mini_projects/2022_gender_differences/KED2023_presentation.pdf) [[Code](https://github.com/aflueckiger/KED2023/tree/main/KED2023/materials/mini_projects/2022_gender_differences)], Dario Haab, Valentina Meyer, Nils Brun, 2022
...
Students planning to write a seminar paper should send me an email with a short outline of their research idea until **15 May 2023** at the latest. When you would like to discuss your idea in person, feel free to do so any time after the seminar.
...
* Deadline for submitting the final paper: **31 August 2023**.
...
[{{< fa desktop size=xl >}}](lectures/html/ked2024_11.html){target="_blank"} [{{< fa file-pdf size=xl >}}](lectures/pdf/ked2024_11.pdf){target="_blank"} [{{< fa brands github size=xl >}}](https://github.com/aflueckiger/KED2024/tree/main/ked2024/lectures/md/ked2024_11.md){target="_blank"} [{{< fa video size=xl >}}](https://tube.switch.ch/videos/dhwlYVZGuZ)

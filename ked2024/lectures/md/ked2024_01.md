...
## ~~Hearing~~ Speaking like a Human?

### Speech-to-Text (S2T)

Recognizing speech robustly (e.g. language, accent, noise)

-   [stunning transcription](https://openai.com/blog/whisper/) by Whisper[@Radford2022]; [try](https://huggingface.co/spaces/Xenova/whisper-web) in your browser
...
::: incremental
-   is a **brand** rather than technology
...
::: columns
::: {.column width="70%"}
-   ChatGPT challenges traditional search engines (e.g. Google Search)

-   Smart assistance rather than search only

    -   answer with source attribution instead of ranked snippet
    -   [Microsoft Copilot](https://www.bing.com/search?q=Bing+AI&showconv=1&FORM=hpcodx), [Google Bart](https://bard.google.com/chat), [you.com](https://you.com/?chatMode=default)
:::

::: {.column width="30%"}
![More complex query on you.com](../images/search_engine_you.png){width="80%"}
:::
:::
...
## Interact with images using text
...
## Personal example {.center data-background-image="../images/ma_flueckiger_country_mentions_black.png"}

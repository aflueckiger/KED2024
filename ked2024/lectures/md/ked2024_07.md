...
# Questions? {.white-text data-background="../images/paint-anna-kolosyuk-unsplash.jpg"}
...
2.  `wget` is a powerful tool. Have a look at its arguments and search for more examples in tutorials on the web.Have a nice <br>Easter break! {data-background-image=../images/easter-eggs.jpg}